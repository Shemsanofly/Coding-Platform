...
urlpatterns = [
    ...
    path("admin/users/<int:user_id>/weaknesses/", AdminUserWeaknessesView.as_view(), name="admin-user-weaknesses"),
    path(
        "admin/users/<int:user_id>/recommendations/",
        AdminUserRecommendationsView.as_view(),
        name="admin-user-recommendations",
    ),
    path("admin/users/<int:user_id>/quiz-log/", AdminUserQuizLogView.as_view(), name="admin-user-quiz-log"),
    path(
    ...
    path("admin/reports/students/", AdminStudentsReportView.as_view(), name="admin-report-students"),
    path("admin/reports/weaknesses/", AdminWeaknessesReportView.as_view(), name="admin-report-weaknesses"),
    path("admin/reports/ai-generation/", AdminAIGenerationReportView.as_view(), name="admin-report-ai-generation"),
    path("reports/my-progress/", StudentProgressReportView.as_view(), name="student-report-progress"),
    path("reports/my-quiz-performance/", StudentQuizPerformanceReportView.as_view(), name="student-report-quiz"),
    path("reports/my-weaknesses/", StudentWeaknessesReportView.as_view(), name="student-report-weaknesses"),
    path("reports/my-learning-path/", StudentLearningPathReportView.as_view(), name="student-report-learning-path"),
]
