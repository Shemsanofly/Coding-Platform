...
class FlaskRuntimeTests(unittest.TestCase):
    ...
    def app(self):
        ...
        return create_app({"TESTING": True, "DATABASE_PATH": self.db_path, "SECRET_KEY": "test-secret"})
    ...
    def test_api_and_versioned_api_alias_require_flask_auth(self):
        ...
        self.assertEqual(legacy.get_json()["detail"], "Authentication credentials were not provided.")
        self.assertEqual(versioned.get_json()["detail"], "Authentication credentials were not provided.")
