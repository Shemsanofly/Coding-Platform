...
def test_admin_can_update_student():
    admin = User.objects.create_user(
        email="admin-students@example.com", password="pass", role="admin"
    )
...
def test_non_admin_cannot_update_or_delete_student():
    ...
    student = User.objects.create_user(
        email="protected@example.com", password="pass", role="student"
    )
...
def test_admin_users_filter_by_weakness_level():
    ...
    admin = User.objects.create_user(
        email="admin-filter@example.com", password="pass", role="admin"
    )
...
def test_admin_cannot_purge_active_student():
    admin = User.objects.create_user(
        email="admin-purge-block@example.com", password="pass", role="admin"
    )
    student = User.objects.create_user(
        email="still-active@example.com", password="pass", role="student"
    )
    client = APIClient()
    client.force_authenticate(admin)
